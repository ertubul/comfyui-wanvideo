...
# WanVideo I2V workflow için özelleştirilmiş

# Default workflow - İsterseniz kendi workflow'unuzu buraya ekleyebilirsiniz
DEFAULT_WORKFLOW="https://raw.githubusercontent.com/ertubul/comfyui-wanvideo/refs/heads/main/wanvideo-ertubul-720p.json"

APT_PACKAGES=(
    # Gerekirse ek paketler ekleyin
)

PIP_PACKAGES=(
    # Gerekirse ek Python paketleri ekleyin
)

# ComfyUI için gerekli node'lar - güncel linkler
NODES=(
    # Temel ComfyUI node'ları ve yönetim araçları
    ...
    # Video işleme için gerekli node'lar
    "https://github.com/Kosinkadink/ComfyUI-VideoHelperSuite"
    "https://github.com/Fannovel16/ComfyUI-Frame-Interpolation"

    # Diğer faydalı node'lar
...
WORKFLOWS=(
    # Kendi workflow repo'nuzu buraya ekleyebilirsiniz
)

CHECKPOINT_MODELS=(
    # Standart SD checkpoint modellerine ihtiyaç yok
)
...
CLIP_MODELS=(
    # CLIP modelleri - gerekirse ekleyin
)
...
LORA_MODELS=(
    # LoRA modelleri - gerekirse ekleyin
)
...
# Film VFI (Frame Interpolation) modeli
FILM_VFI_MODEL=(
...
function provisioning_start() {
    ...
    # Film VFI modelini indirin
    mkdir -p "${WORKSPACE}/ComfyUI/models/frame_interpolation"
    for url in "${FILM_VFI_MODEL[@]}"; do
        printf "Downloading FILM model: %s\n" "${url}"
        provisioning_download "${url}" "${WORKSPACE}/ComfyUI/models/frame_interpolation"
        printf "\n"
    done
        
    # Gerekirse workflow'unuzu kopyalayın
